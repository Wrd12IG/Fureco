...
v6 = v4[:v4_html_start] + v5[v5_html_start:v5_coll_end] + v4[v4_coll_end:]

# 2. Desktop CSS Replace
v4_css_start = v6.find('/* ============================================================\n     HERO 50/50 SPLIT')
v4_css_end = v6.find('/* ============================================================\n     SECTIONS (after hero)')

v5_css_start = v5.find('/* ==================== VIDEO FULL WIDTH ==================== */')
v5_css_end = v5.find('/* ==================== MOBILE ==================== */')

v6 = v6[:v4_css_start] + v5[v5_css_start:v5_css_end] + v6[v4_css_end:]
...
v6 = v6[:v4_mob_start] + v5[v5_mob_start:v5_mob_end] + v6[v4_mob_end:]
